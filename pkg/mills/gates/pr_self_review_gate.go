...
const (
	PRSelfReviewReasonPassed      = "pr_self_review.passed"
	PRSelfReviewReasonBelowScore  = "pr_self_review.below_threshold"
	PRSelfReviewReasonUnavailable = "pr_self_review.evaluation_unavailable"
)
...
func NewPRSelfReviewGate(judge RubricJudge) *reasonCodedLLMGate {
	return &reasonCodedLLMGate{LLMGate: &LLMGate{
		GateName:   "pr_self_review",
		RubricName: PRSelfReviewRubricName,
		Threshold:  0.7,
		Judge:      judge,
	}, passCode: PRSelfReviewReasonPassed, failCode: PRSelfReviewReasonBelowScore,
		unavailableCode: PRSelfReviewReasonUnavailable}
}
