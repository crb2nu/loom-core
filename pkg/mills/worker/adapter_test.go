...
// TestRunMapsRequestFieldsByteIdentical asserts the adapter forwards the
// SpawnRequest the spawn client would have received pre-Layer-1, i.e. the
// mapping is behavior-preserving against the existing boundary.
