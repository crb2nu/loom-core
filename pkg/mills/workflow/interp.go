...
//
// This slice (S0) ships ONLY the pure runtime + DAO-backed journal. No
// operator, scheduler, or WorkerRunner wiring — those are deferred to a later
// slice.
//
...
// buildUniverse returns the EXACTLY-six predeclared names. No os/time/random,
// no load. Capability confinement is by construction.
...
// 6 effect builtins — nothing else. Tests assert against it so a future leak
