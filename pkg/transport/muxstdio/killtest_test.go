...
// and a stdio round-trip. Picked over agent_recall (which calls an
...
// callRecall issues a single agent_recall via the demuxer. Kept around
// because the spec's original payload was a recall call; useful as a single
...
// agent_recall calls through the prototype demuxer and asserts:
//
