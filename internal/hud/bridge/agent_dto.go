...
// reasoningChainEntry mirrors the agent_reasoning_chain_list wire format.
...
// reasoningChainDetailEntry mirrors the agent_reasoning_chain_get wire format.
type reasoningChainDetailEntry struct {
	ChainID    string                    `json:"chain_id"`
	Query      string                    `json:"query"`
	Conclusion string                    `json:"conclusion"`
	Confidence float64                   `json:"confidence"`
	CreatedAt  string                    `json:"created_at"`
	Steps      []reasoningChainStepEntry `json:"steps"`
}

// reasoningChainStepEntry mirrors a step in the reasoning chain wire format.
type reasoningChainStepEntry struct {
