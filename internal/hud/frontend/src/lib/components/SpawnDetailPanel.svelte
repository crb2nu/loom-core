<script lang="ts">
  ...
  import { relativeTime, statusColor } from '../utils/format.ts';
  ...
  import ActivityTab from './spawn-telemetry/ActivityTab.svelte';
  import TranscriptTab from './spawn-telemetry/TranscriptTab.svelte';
  import ToolsTab from './spawn-telemetry/ToolsTab.svelte';
  import FilesTab from './spawn-telemetry/FilesTab.svelte';
  import ErrorsTab from './spawn-telemetry/ErrorsTab.svelte';
  import UsageTab from './spawn-telemetry/UsageTab.svelte';
  ...
  // creating/building are healthy startup states — 'degraded' rendered a
  // booting spawn as an amber pulsing fault triangle.
  function statusToDot(status: string): 'healthy' | 'idle' | 'degraded' | 'down' {
    switch (status) {
      case 'running': return 'healthy';
      case 'building': return 'idle';
      case 'creating': return 'idle';
