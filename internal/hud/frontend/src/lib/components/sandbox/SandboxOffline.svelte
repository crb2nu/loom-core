...
<div class="unavailable-shell">
  ...
  <aside class="unavailable-sidecard">
    ...
    <div class="offline-points">
      <div class="offline-point">The devbox backend powers image builds, sandboxed command exec, the fmt → lint → test quality gate, and environment detection.</div>
      <div class="offline-point">When it reconnects, project inventory, detected toolchains, and recent build/exec/gate activity repopulate automatically.</div>
    </div>
  </aside>
</div>
