...
<style>
  .action-toast-stack {
    ...
    gap: 8px;
    /* Topmost transient layer — must sit above modal dialogs (backdrops 9999)
       and the noise grain (10000), matching the primary Toast stack. At the old
       z-index 950 an action result raised while a dialog was open rendered
       behind it. */
    z-index: 10001;
    pointer-events: none;
