<script lang="ts">
  ...
  import type { ConfirmVariant } from '../../utils/confirm.ts';
  ...
  function handleKeydown(event: KeyboardEvent): void {
    if (event.key === 'Escape') {
      // One Escape dismisses one surface: without this the same event also
      // reached a parent DetailDrawer and closed it too.
